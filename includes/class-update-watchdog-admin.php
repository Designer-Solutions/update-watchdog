...
class Update_Watchdog_Admin {

	const TOKEN_OPTION = 'update_watchdog_token';
	...
	public function enqueue_scripts( $hook ) {
		...
		wp_enqueue_script(
			'qrcodejs',
			UPDATE_WATCHDOG_PLUGIN_URL . 'assets/js/qrcode.min.js',
			array(),
			'1.0.0',
			true
		);
			...
			<tr>
				...
				<td>
					<input type="text"
					       ...
					       style="width: 500px; font-family: monospace; font-size: 13px;"
					       onclick="this.select();" />
					<p class="description">
